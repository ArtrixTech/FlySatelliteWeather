...
#End Region
    ...
    Private Sub p3_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles background.MouseMove
        If isdown = True Then
            ...
            Form1.Location = New Point(System.Windows.Forms.Cursor.Position.X - DX - 158, System.Windows.Forms.Cursor.Position.Y - DY)
        End If
    End Sub
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        ...
        PictureBox1.Image = inputPB.Image
    ...
    Sub showIMG(image As Bitmap, pb As PictureBox)
